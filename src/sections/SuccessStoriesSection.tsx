    ...
    <section id="projects" className="projects smt-8">
      <div className="container">
        <div className="section-header">
          <p>{data?.elements?.title?.value.replace(/(<([^>]+)>)/gi, "")}</p>
          <h2>
        ...
        {contentTypes &&
          contentTypes.map((item: any, i: any) => (
            <div className="row mt-5 g-0" key={i}>
              <div
                className={`col-lg-6 ${
                  i % 2 === 1 ? "align-items-center project-card" : ""
                }`}
              >
                {i % 2 === 0 ? (
                  <Link
              ...
              <div
                className={`col-lg-6  ${
                  i % 2 === 0 ? "align-items-center project-card" : ""
                }`}
              >
                {i % 2 === 0 ? (
                  <>
        ...
        <div className="form-group">
          ...
          >
            {data?.elements?.view_btn?.value.replace(/(<([^>]+)>)/gi, "")}
