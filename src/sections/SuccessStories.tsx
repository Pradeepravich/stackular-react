            ...
            <button
              onClick={() =>
                redirectToProjectInfo(
                  portfolioInfo1?.elements?.slug?.value.replace(
                    /(<([^>]+)>)/gi,
                    ""
                  )
                )
        ...
        <div className="row mt-5 g-0">
          ...
          <div className="col-lg-6">
            <button
              onClick={() =>
                redirectToProjectInfo(
                  portfolioInfo2?.elements?.slug?.value.replace(
                    /(<([^>]+)>)/gi,
                    ""
                  )
                )
        ...
        <div className="row mt-5 g-0">
          <div className="col-lg-6">
            <button
              onClick={() =>
                redirectToProjectInfo(
                  portfolioInfo3?.elements?.slug?.value.replace(
                    /(<([^>]+)>)/gi,
                    ""
                  )
                )
        ...
        <div className="row mt-5 g-0">
          ...
          <div className="col-lg-6">
            <button
              onClick={() =>
                redirectToProjectInfo(
                  portfolioInfo4?.elements?.slug?.value.replace(
                    /(<([^>]+)>)/gi,
                    ""
                  )
                )
