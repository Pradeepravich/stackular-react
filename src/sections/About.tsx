          ...
          <div className="row">
                ...
                <div className="col-lg-12 d-none mt-lg-5 d-md-block">
                  <div className="row gy-4">
                    <div className="col-lg-4">
                      <img src={data?.elements?.top_left_img?.value[0]?.url} className="img-fluid mx-auto" alt="" />
                    </div>
                    <div className="col-lg-8">
                      <img src={data?.elements?.top_right_img?.value[0]?.url} className="img-fluid mx-auto" alt="" />
                    </div>
                  </div>
                </div>
              ...
              <div className="container">
                <div className="row g-0">
                  <div className="col-lg-6 project-issues-info">
                    <h2 className="small">{data?.elements?.our_mission?.value.replace(
                          /(<([^>]+)>)/gi,
                          ""
                        )}</h2>
                  </div>
            ...
            <section id="projects" className="projects smb-8">
              <div className="container">
                <div className="row g-0">
                  <div className="col-lg-6 project-issues-info">
                    <h2 className="small">{data?.elements?.our_vision?.value.replace(
                          /(<([^>]+)>)/gi,
                          ""
                        )}</h2>
                  </div>
            ...
            <section id="our_list" className="our-list section-padding">
              <div className="container">
                <div className="row gy-4">
                  ...
                  <h2 className="small"><CountUp start={0} end={data?.elements?.locations?.value} duration={2} prefix="0" /></h2>
                  ...
                  <div className="col-lg-3 our-list-info">
                  <h2 className="small"><CountUp start={0} end={data?.elements?.clients?.value} duration={3} suffix="+" /></h2>
                  ...
                  <div className="col-lg-3 our-list-info">
                  <h2 className="small"><CountUp start={0} end={data?.elements?.consultants?.value} duration={2} suffix="+" /></h2>
                  ...
                  <div className="col-lg-8 all-founders">
                    <div className="row">
                      <div className="col-lg-6 founder-card mt-5">
                        ...
                        <h4 className="mt-2">{data?.elements?.team_founder1?.value.replace(
                          /(<([^>]+)>)/gi,
                          ""
                        )}</h4>
                      ...
                      <div className="col-lg-6 founder-card mt-5">
                        ...
                        <h4 className="mt-2">{data?.elements?.team_founder2?.value.replace(
                          /(<([^>]+)>)/gi,
                          ""
                        )}</h4>
                ...
                <div className="row gy-4">
                  <div className="col-lg-12 commitment-head">
                    <div className="section-header">
                      ...
                      <h3 className="mt-lg-3">{data?.elements?.commitment?.value.replace(
                          /(<([^>]+)>)/gi,
                          ""
                        )}</h3>
                    </div>
